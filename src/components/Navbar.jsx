      ...
      <div className="navbar flex w-full justify-between items-center px-[5vw] md:h-[10vh] relative z-999 h-auto">
          ...
          <div className="">
            ...
            >
              ...
              <a href="/public/Blue and White Clean and Professional Resume.pdf" target="_blank" rel="noopener noreferrer" className="py-2 transition trail-text z-70 text-transparent" style={{ WebkitTextStroke: "1px white" }}>CV</a>
            </div>
      </div>
    </>
  );
